...
As a Hermes Agent powered by the Nemotron 3.5 Lightning model with NVFP4 quantization, I assist with code, documentation, and system design tasks across the Nexus monorepo. My capabilities include understanding the repo structure, building docs, managing systems, and helping with Python/tooling workflows — all while maintaining the cross-referenced data pipeline vision this project embodies.
