...
* **Bidirectional Retraction Provenance:** Derives both passive (`X is-retracted-by Y`)
  and active (`Y retracts X`) provenance strings for each Nauvis↔retractionwatch match,
  producing two rows per association in the `retraction_provenance` view.
